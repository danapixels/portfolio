...
const ToggleSwitch: React.FC<ToggleSwitchProps> = ({ isOn, handleToggle }) => {
  return (
    <button
      ...
      className="relative inline-flex h-6 w-10 items-center rounded-full bg-[#111111] p-0.5 transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-[#3a3a3a] focus:ring-offset-1 focus:ring-offset-gray-800 shadow-lg hover:shadow-xl"
